...
{
    public class AdsRefillEnergy : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener
    {
        ...
        {
            GameObject.FindWithTag("Player").GetComponent<PlayerEntity>().Core.EnergySystem.IncreaseStat(200);
