...
namespace _Sources.Scripts.Helpers
{
    public class GameActions : SingletonClass<GameActions>
    {
        ...
        public event Action<Transform> OnSpawnerDestroyed;

        public void SpawnerDestroyedTrigger(Transform spawnerGo)
        {
            if (OnSpawnerDestroyed != null)
            {
                OnSpawnerDestroyed(spawnerGo);
            }
        }
